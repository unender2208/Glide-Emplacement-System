...
ENT.Author = "unender"
ENT.PrintName = "M2HB Browning"

DEFINE_BASECLASS( "base_glide_emplacement" )

ENT.GlideCategory = "UNENDER_EMPLACEMENTS"
ENT.ChassisModel = "models/kali/vehicles/cod4/technical_mg_m2.mdl"
...
if CLIENT then
    ...
    function ENT:OnActivateMisc()
        ...
        self.turretBaseBone = self:LookupBone( "rot" )
        self.turretWeaponBone = self:LookupBone( "elev" )
    end
    ...
    function ENT:OnUpdateAnimations()
        ...
        function self:GetFirstPersonOffset( seatIndex, localEyePos )
            ...
            localEyePos[3] = localEyePos[3] + math.tan( rad2 ) + 15
            localEyePos[2] = localEyePos[2] + 5 + math.sin( rad ) * -30
            localEyePos[1] = localEyePos[1] + math.cos( rad ) * -30
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        local turret = self:CreateEmplacementTurret( self, Vector( -0, 4.3, 7 ), Angle() )
        turret:SetFireDelay( 0.13 )
        turret:SetBulletOffset( Vector( 55, 0, 0 ) )
        ...
        self:CreateSupport( Vector( 0, 0, -45 ), Angle( 0, -0, 0 ) )
