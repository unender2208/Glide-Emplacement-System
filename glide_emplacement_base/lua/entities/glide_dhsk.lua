...
if CLIENT then
    ...
    function ENT:OnUpdateAnimations()
        ...
        function self:GetFirstPersonOffset( seatIndex, localEyePos )
            ...
            localEyePos[3] = localEyePos[3] + math.tan( rad2 ) * 25
            localEyePos[2] = localEyePos[2] + math.sin( rad ) * -27
            localEyePos[1] = localEyePos[1] + math.cos( rad ) * -27
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        local turret = Glide.CreateTurret( self, Vector( -0, 0, 0 ), Angle() )
        ...
        Glide.HideEntity( turret, false )
        Glide.HideEntity( turret:GetGunBody(), false  )
